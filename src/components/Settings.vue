...
export default {
    components: { ATitle, AButton, ASelect, ATextInput, ALink },
    props: { show: Boolean },
    computed: {
    ...
    methods: {
        getLocaleName(locale) { return where('1', locale).local; },
        ...
        close() { this.$emit('update:show', !this.show); }
    }
}
</script>
...
@media only screen and (min-width: 768px) and (min-height: 768px) {
    .modal .inner { width: auto !important; min-width: 350px; }
}
</style>
